---
layout: default
page_title                                : 프린세스 플랜트!                           # Automatically populates with app name if not set and if iOS app ID is set. Otherwise enter manually.
...
app_description                           : test version 2
...
cover_image                               : assets/testheaderimage.png                    # Replace with alternative image path or image URL.
